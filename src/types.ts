 ...
 */
export type FlashcardListItemDto = Pick<FlashcardRow, "id" | "front" | "back" | "source" | "created_at" | "updated_at">;

/**
 * Flashcard representation used when returning a single flashcard or mutation result.
 */
export type FlashcardDetailDto = FlashcardListItemDto & Pick<FlashcardRow, "generation_id">;
 ...
 */
export type FlashcardDraftCommand = Pick<FlashcardInsert, "front" | "back" | "source" | "generation_id">;
 ...
 */
export type UpdateFlashcardCommand = Pick<FlashcardUpdate, "front" | "back" | "source" | "generation_id">;
 ...
 */
export type CreateGenerationCommand = Pick<GenerationInsert, "source_text">;

/**
 * Flashcard proposal returned alongside generation metadata.
 */
export type GenerationFlashcardProposalDto = Pick<FlashcardInsert, "front" | "back" | "source">;
