...
export type CreateFlashcardsCommandInput = z.infer<typeof createFlashcardsCommandSchema>;
...
export const updateFlashcardCommandSchema = z
  ...
  .refine(
    (val) =>
      val.front !== undefined || val.back !== undefined || val.source !== undefined || val.generation_id !== undefined,
